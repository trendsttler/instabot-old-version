...
bot = InstaBot(
    ...
    #login="hipsters.trend",
    #password="SADEVRA72722",
    like_per_day=1500,
    comments_per_day=350,
    tag_list=["travel", "travelphotography", "photography", "nature", "travelgram", "love", "photooftheday", "instatravel", "instagood", "wanderlust", "trip", "travelblogger", "adventure", "traveling", "vacation", "picoftheday", "travelling", "explore", "instagram", "landscape", "beautiful", "ig", "holiday", "like", "beach", "summer", "naturephotography", "art", "photo", "bhfyp"],
    ...
    unfollow_whitelist=["sonalii.sharmaa", "saniya_khaton_13", "simran_thakur743", "___sachi.__", "anushka4nov", "fulwanideepa",
                         ...
                         "shruti_verma_", "panwarversha8", "saru_3565","riyakshay7784","___bhavya_jain","shivani.022","yuktiarora24","divyapandey_official"
  ],
